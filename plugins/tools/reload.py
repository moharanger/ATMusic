...
from ATMusic.utils.database import get_authuser_names, get_cmode
from ATMusic.utils.decorators import ActualAdminCB, AdminActual, language
from ATMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await AT.stop_stream(message.chat.id)
    except:
        pass
